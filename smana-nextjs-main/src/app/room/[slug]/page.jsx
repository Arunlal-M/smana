...
function RoomDetailsPage() {
    ...
    const roomPost = Posts.find(post => post.slug === slug); // Find the post by slug

    if (!roomPost) {
        return <div>Post not found!</div>; // Show a not found message if the roomPost does not exist
    }
                        ...
                        <div className="col-xxl-8 col-xl-7">
                            <div className="room__details">
                                ...
                                <p>
                                    ...
                                    <br /> <br />
                                    Indulge in a culinary journey at our on-site restaurants, where our
                                    talented chefs create mouthwatering dishes using the freshest local
                                    ingredients. Start your day with a sumptuous breakfast, enjoy a leisurely
                                    lunch, and savor a gourmet dinner in an elegant setting.
                                </p>

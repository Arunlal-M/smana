                    ...
                    <div className="row">
                        <div className="main__header__wrapper">
                                    ...
                                    <nav className="navigation__menu" id="main__menu">
                                        <ul className="list-unstyled ">
                                            ...
                                            <li className="navigation__menu--item">
                                                <Link href="/" className="navigation__menu--item__link text-black">
                                            ...
                                            <li className="navigation__menu--item has-child has-arrow">
                                                <Link href="/" className="navigation__menu--item__link">
                                                    <span style={{ color: "#fff !important" }}>Explore</span>
                                                </Link>
                                                <ul className="submenu sub__style" role="menu">
                                                    <li role="menuitem">
                                            ...
                                            <li className="navigation__menu--item">
                                                ...
                                                >
                                                    <span style={{ color: "#fff !important" }}>Contact</span>
                                                </Link>
                                            </li>
                                            <li className="navigation__menu--item pl-5">
                                                <Link
                                                    href="/about"
                                                    className="navigation__menu--item__link"
                                                >
                                                    <span style={{ color: "#fff !important" }}>Who&nbsp;We&nbsp;Are?</span>
                                                </Link>
                                            </li>
                                        </ul>
                                    </nav>
                            ...
                            <div className="main__right">
                                ...
                                >
                                    <span style={{ color: "#fff !important" }}>Sign In</span>
                                </button> */}
                                ...
                                >
                                    <span style={{ color: "#fff !important" }}>Sign Up</span>
                                </button> */}
